			...
			<div class="span1_of_1">
				...
				<div class="product-view">
				    ...
				    <div class="product-image"> 
				        <a class="cs-fancybox-thumbs cloud-zoom" rel="adjustX:30,adjustY:0,position:'right',tint:'#202020',tintOpacity:0.5,smoothMove:2,showTitle:true,titleOpacity:0.5" data-fancybox-group="thumb" href="images/slider3.png">
				           	<img src="images/slider3.png"/>
				        </a>
				   </div>
					<script type="text/javascript">
						var prodGallery = jQblvg.parseJSON('{"prod_1":{"main":{"orig":"images/slider3.png","main":"images/slider3.png","thumb":"images/slider3.png","label":""},"gallery":{"item_0":{"orig":"images/slider3.png","main":"images/slider3.png","thumb":"images/slider3.png","label":""} "type":"simple","video":false}}'),
			...
			<div class="span1_of_1_des">
				  <div class="desc1">
			   	...
			   	<!-- start tabs -->
			        ...
			        <label for="tab-1" class="tab-label-1">Deskripsi</label>
			        ...
			        <div class="content">
				        <div class="content-1">
				        	<p class="para top">Deskripsi Produk</p>
							<div class="clear"></div>
						</div>
				        <div class="content-2">
